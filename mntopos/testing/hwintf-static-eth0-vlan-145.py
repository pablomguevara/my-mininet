...
Root Node acting as router 192.168.145.254
...
def testNetwork():
  ...
  # add vlans
  root.cmd('vconfig add root-eth0 145')
  h1.cmd('vconfig add h1-eth0 145')
  h2.cmd('vconfig add h2-eth0 145')
  
  # add ip addresses on vlan 145
  root.cmd('ifconfig root-eth0.145 192.168.145.253 netmask 255.255.255.0 up')
  h1.cmd('ifconfig h1-eth0.145 192.168.145.101 netmask 255.255.255.0 up')
  h2.cmd('ifconfig h2-eth0.145 192.168.145.102 netmask 255.255.255.0 up')
